...
def objective(trial):
    ...
    args = TrainingArguments(
        output_dir=f"results_bert/trial_{trial.number}",
        eval_strategy="epoch",
        save_strategy="epoch",
...
training_args = TrainingArguments(
    output_dir="full_finetuned_bert",
    eval_strategy="epoch",
    save_strategy="epoch",
...
plt.tight_layout()
plt.savefig("results_bert/confusion_matrix_test.png", bbox_inches="tight", dpi=300)
plt.close(fig)
print("✅ Confusion matrix saved to results_bert/confusion_matrix_test.png")
...
plt.tight_layout()
plt.savefig("results_bert/roc_curve_test.png", bbox_inches="tight", dpi=300)
plt.close(fig)
print("✅ ROC curve saved to results_bert/roc_curve_test.png")

# ==========================
# 10. Save model & weights
# ==========================
model_dir = "results_bert/best_full_finetuned_bert"
trainer.save_model(model_dir)

# Also save as .pt checkpoint
pt_path = os.path.join("results_bert", "best_full_finetuned_bert.pt")
